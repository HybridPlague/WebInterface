					...
					if(empty($_POST['firstName']) || empty($_POST['lastName']) || empty($_POST['email']) || empty($_POST['subject']) || empty($_POST['message']) || empty($_POST['captcha'])) {
						...
						if(@eregi("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $_POST['email'])) {
							if($_POST['captcha'] !== $_SESSION['captcha']) {
								...
								$headers  = "From: The Big Bad Birds <no-reply@Siri.playfrog4u.com>\r\n";
							...
							<html>
							  ...
							  * { margin: 0; padding: 0; }
							  ...
							  #top {
								  height: 175px;
								  background: #EEE url("http://siri.playfrog4u.com/img/topMailLogo.png") center left no-repeat;
							  ...
							  <div id="top"></div>
							  <div id="middle">
							  <h1>The Big Bad Birds :: Contact</h1>
							  <p><b>Name:</b> ' . $_POST['firstName'] . " " . $_POST['lastName'] . '<br />
							   ...
							   <div id="bottom">Email sent on ' . date("l") . " the " . date("jS") . " around " . date("h:s a") . '. <br />By <a href="http://twitter.com/playfrog4u">@Playfrog4u</a></div>
							  </body>
							</html>';
								...
								if(mail($to, $subject, $message, $headers)) {
									...
									echo '<p id="response" class="notification red">Something went wrong while sending the email to the administrator, try contacting <a href="http://twitter.com/playfrog4u">@Playfrog4u</a> on Twitter.</p>';
								}
							}
						}
						else {
